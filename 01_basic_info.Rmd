...
```{r, data}
data<- luispack::load_xml(folder =  "data/xml",
...
temp<- unique(data[!obs_status %in% c("L","M") & !is.na(obs_value) ,.(first = min(time_period), last = max(time_period)),by =.(table_identifier,country,sto,unit_measure)])%>% 
